package hp04_home_product_detail
...
class CheckProductDetail {
     ...
     */
    @Given("User navigate to the Web")
    def NavigateToHome() {
    ...
    @And("Click Product")
    def ClickProductDetail() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/home/click_product_detail'), null, FailureHandling.STOP_ON_FAILURE)
    }

    @Then("Product detail will show")
    def VerifyProductDetail() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/home/verify_product_detail'), null , FailureHandling.STOP_ON_FAILURE)
    }
}