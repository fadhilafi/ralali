...
class bidpricewebBP03 {
    ...
    def ClickButtonSayaTertarikBP03() {
    ...
    def FillHargaTawarBP03() {
        WebUI.callTestCase(findTestCase('Test Cases/secondhand-web/helper/bid_a_price/fill_hargatawar_minus'), null, FailureHandling.STOP_ON_FAILURE)
    }
