...
class bidpricewebBP01 {
    ...
    def ClickButtonSayaTertarikBP01() {
    ...
    def FillHargaTawarBP01() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/bid_a_price/fill_hargatawar'), null, FailureHandling.STOP_ON_FAILURE)
    }
