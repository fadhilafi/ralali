...
class bidpricewebBP02 {
    ...
    def ClickButtonSayaTertarikBP02() {
    ...
    def FillHargaTawarBP02() {
        WebUI.callTestCase(findTestCase('Test Cases/secondhand-web/helper/bid_a_price/fill_hargatawar_string'), null, FailureHandling.STOP_ON_FAILURE)
    }
