package pdt01_product_diminati
...
class ProductDiminati {
    /**
     * The step definitions below match with Katalon sample Gherkin steps
     */
    @Given("User has navigate to web PDT 01")
    ...
    @When("User click Button login PDT 01")
    def clicklogin() {
    ...
    @And("User click Button submit PDT 01")
    def ClickSubmit() {
    ...
    @And("User click Button Hamburger list PDT 01")
    def ClickHamburgerList(int value) {
    ...
    @Then("User verify Button Diminati PDT 01")
    def ClickDiminati() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/product_diminati_terjual/verify_diminati'), null, FailureHandling.STOP_ON_FAILURE)
    }
}