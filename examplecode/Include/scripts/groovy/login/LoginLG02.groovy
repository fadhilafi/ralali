...
class LoginLG02 {
    ...
    def FillEmail() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/login/fill_email_LG02'),null, FailureHandling.STOP_ON_FAILURE)
    }

    @And("Fill Password incorrect value LG_02")
    def FillPassword() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/login/fill_password_LG02'),null, FailureHandling.STOP_ON_FAILURE)
    }
