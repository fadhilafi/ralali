...
class mandatoryfieldblank {
    ...
    def FillNamaProduk() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/add_product/fill_namaproduk_mandatory'),null, FailureHandling.STOP_ON_FAILURE)
    }

    @And("Fill Harga Produk PD03")
    def FillHargaProduk() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/add_product/fill_hargaproduk_mandatory'),null, FailureHandling.STOP_ON_FAILURE)
    }
    ...
    def FillDeskripsi() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/add_product/fill_deskripsi_mandatory'),null, FailureHandling.STOP_ON_FAILURE)
    }
