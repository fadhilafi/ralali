...
public class TC_RG_02 {
    ...
    def clickfieldemail() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/register/fill_email_registered'), null, FailureHandling.STOP_ON_FAILURE)
    }
    ...
    def I_verify_the_status_in_step() {
        println 'Cannot Register "Email sudah terdaftr!"'
    }
}
