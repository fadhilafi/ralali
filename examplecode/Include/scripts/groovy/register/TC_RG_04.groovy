...
public class TC_RG_04 {
    ...
    def clickfieldnama() {
        WebUI.callTestCase(findTestCase('Test Cases/secondhand-web/helper/register/fill_nama_lengkap'), null, FailureHandling.STOP_ON_FAILURE)
    }

    @And("Fill in email field with incorrect format RG_04")
    def clickfieldemail() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/register/fill_email_incorrect'), null, FailureHandling.STOP_ON_FAILURE)
    }
