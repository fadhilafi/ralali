...
class BidAPriceZero {
    ...
    def TapProductDetailBidPriceZero() {
    ...
    def TapButtonSayaTertarikdanInginNegoZero() {
    ...
    def FillHargaTawarZero() {
        Mobile.callTestCase(findTestCase('secondhand-app/helper/bid_a_price/set_bid_a_price_zero'),null, FailureHandling.STOP_ON_FAILURE)
    }

    @Then("Click on Kirim button Zero")
    def ClickButtonBidAPriceZero() {
