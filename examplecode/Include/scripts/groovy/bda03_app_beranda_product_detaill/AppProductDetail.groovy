package bda03_app_beranda_product_detaill
...
public class AppProductDetail {
    ...
    def VerifyProductDetail() {
        Mobile.callTestCase(findTestCase('secondhand-app/helper/beranda/verify_text_detail_productTest Cases/secondhand-app/helper/beranda/verify_text_detail_product'), null , FailureHandling.STOP_ON_FAILURE)
    }
}