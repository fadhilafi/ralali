...
class HomepageHP02 {
    ...
    def TypedInKeyword() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/search_product/fill_keyword_HP02'),null, FailureHandling.STOP_ON_FAILURE)
    }

    @Then("Product will show based on keyword searched HP_02")
    def VerifyProduct() {
        WebUI.callTestCase(findTestCase('secondhand-web/helper/search_product/verify_product'), null , FailureHandling.STOP_ON_FAILURE)
    }
}